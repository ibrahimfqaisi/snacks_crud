...
class Snacktest(TestCase):
    ...
    def test_fields_model(self):
        self.assertEquals(self.snack.purchaser,self.user)
        self.assertEquals(self.snack.title,"test")
        self.assertEquals(self.snack.description,"there is no description")
